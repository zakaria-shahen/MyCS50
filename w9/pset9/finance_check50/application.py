...
API_KEY = "pk_52f12d9b510c4bf5aa57c26f51f9ada7"
...
def buy():
    ...
    if data == None:
        ...
        # return redirect("/buy")
        return apology("lookup(): not found symbol OR API Error")
...
def register():
    ...
    if not username or not password:
        ...
        return apology("Please enter your password, username, or both")
...
def sell():
    ...
    if request.method == "POST":
        ...
        if data == None:
            ...
            return apology("lookup(): Wrong symbol OR Error API")
        ...
        with sqlite3.connect(db_name) as db:
            ...
            try:
                ...
                # return redirect("/sell")
                return apology("does not own any shares of that stock \n OR \n does not own that many shares of the stock.")
